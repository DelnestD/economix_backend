...
export async function seeder() {
    ...
    const [brenda, audrey, maxime] = manager.create(User, [
        {
            ...
            password: "$2a$10$75cnmO/EDFamlImEGycq7.gV56dbupVHb47ksjw8Eo9MtxDpHWrmG",
            group: null,
        },
        {
            lastName: "Larousse",
            ...
            password: "$2a$10$WOGRxtBQqXVuOjL5ZN7.2.hv8eGIJM75410S/6ZkBn3fB1rl5BWT2",
            group: null,
        },
        {
            lastName: "Lamenace",
            ...
            password: "$2a$10$FbnmToeZg0BwijEVX3hHVewYCSrDlC5JmjnwGRu/FEmLmuMz2nloG",
            group: null,
        },
    ]);
    ...
    const denis = manager.create(User, {
        ...
        password: "$2a$10$TNB/zA6SxiKw3PmCvspj8O.5eDSGIUf93apPU4c2cxtkWWyCQkGNK",
        group: null,
    });
    ...
    const romain = manager.create(User, {
        ...
        password: "$2a$10$qwx.Oq69Id1mgU7cKQsgKenZrX6r1kqxvrDFrxQ4Qob6gZ8fY6dv6",
        group: null,
    });
    ...
    const [huguette, hector, henry, kevin, jeanEudes, gneeeeeh] = manager.create(User, [
        {
            ...
            password: "$2a$10$jMr6qpzMVzMsHFlTexNBxeBc1v3FVv/Xbmnzyo9/M7ciIqJg4uJVm",
            group: null,
        },
        {
            lastName: "ch'nord",
            ...
            password: "$2a$10$1D9lBEcHxfHfIOsXbTSLMewuJUOUx/Htnb1CMA/0Y4iwSv6QHgj8q",
            group: null,
        },
        {
            lastName: "ch'nord",
            ...
            password: "$2a$10$hnHoUtOkbYS2.WVJ.CwKCu6GqgRzjoc13UizGGvCaI7DgHT1szRc6",
            group: null,
        },
        {
            lastName: "ch'nord",
            ...
            password: "$2a$10$yIzI/EkCryeH14KqQbNFaeK8A3NmdYf3COBYizSSQ5GYW2tm9/WCO",
            group: null,
        },
        {
            lastName: "ch'nord",
            ...
            email: "je86@TS21.fr",
            password: "$2a$10$QqRprwuv3MTRJVz1IAQ3iu8xBAvKBSeshvZ0VKu5Puquj851TX54i",
            group: null,
        },
        {
            lastName: "ch'nord",
    ...
    const [steve, corine] = manager.create(User, [
        {
            ...
            password: "$2a$10$aS/IMuW.xTi3.Zg0YW85N.kt5bQmF4eeGDgoFVPmdr3dvh8hOs9eu",
            group: null,
        },
        {
            lastName: "Aminnon",
            ...
            password: "$2a$10$mhljXdRwwESQzAPT1vPCjOV6psjbJiUjTCL4tNiQNAIFAFQMmqwHK",
            group: null,
        },
    ]);
    ...
    const diana = manager.create(User, {
        ...
        firstName: "Diana",
        email: "dp@test.com",
        password: "$2a$10$HDPyA/wRMdQVkm34LYtKQ.LJQQMrzhteysAosTSja8OeDZp73RWpO",
        group: null,
    });
